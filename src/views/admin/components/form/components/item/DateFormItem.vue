...
const model = computed({
  get: () => formModel.value[props.formItem.property] ? (formModel.value[props.formItem.property].date ? formModel.value[props.formItem.property].date : formModel.value[props.formItem.property]) : '',
  set: (value: string) => {
